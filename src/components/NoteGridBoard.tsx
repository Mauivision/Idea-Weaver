    ...
    >
      ...
      {linkMenuAnchor && (
        ...
        >
          {ideas
            .filter((i) => {
              const sourceConnections = ideas.find((x) => x.id === linkMenuAnchor.ideaId)?.connections ?? [];
              return i.id !== linkMenuAnchor.ideaId && !sourceConnections.includes(i.id);
            })
            .map((target) => (
              <MenuItem
                key={target.id}
      ...
      {unlinkMenuAnchor && (
        ...
        >
          {ideas
            .filter((i) => {
              const sourceConnections = ideas.find((x) => x.id === unlinkMenuAnchor.ideaId)?.connections ?? [];
              return sourceConnections.includes(i.id);
            })
            .map((target) => (
              <MenuItem
                key={target.id}
